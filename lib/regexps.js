...
parser = Object.create(null);
parser[0] = new RegExp("(008|Altresium|Argus|BaiduMobaider|BoardReader|DNSGroup|DataparkSearch|EDI|Goodzer|Grub|INGRID|Infohelfer|LinkedInBot|LOOQ|Nutch|PathDefender|Peew|PostPost|Steeler|Twitterbot|VSE|WebCrunch|WebZIP|Y!J-BR[A-Z]|YahooSeeker|envolk|sproose|wminer)/(\\d+)(?:\\.(\\d+)(?:\\.(\\d+))?)?(?:(?!CFNetwork).)*$");
parser[1] = 0;
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("(Google-HTTP-Java-Client|Apache-HttpClient|http%20client|Python-urllib|HttpMonitor|TLSProber|WinHTTP|JNLP)(?:[ /](\\d+)(?:\\.(\\d+)(?:\\.(\\d+))?)?)?");
parser[1] = 0;
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("(?:\\/[A-Za-z0-9\\.]+)? *([A-Za-z0-9 \\-_\\!\\[\\]:]*(?:[Aa]rchiver|[Ii]ndexer|[Ss]craper|[Bb]ot|[Ss]pider|[Cc]rawl[a-z]*))/(\\d+)(?:\\.(\\d+)(?:\\.(\\d+))?)?(?:(?!CFNetwork).)*$");
parser[1] = 0;
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("((?:[A-z0-9]+|[A-z\\-]+ ?)?(?: the )?(?:[Ss][Pp][Ii][Dd][Ee][Rr]|[Ss]crape|[A-z]{2}(?!C[Uu])[Bb]ot|[Cc][Rr][Aa][Ww][Ll])[A-z0-9]*)(?:(?:[ /]| v)(\\d+)(?:\\.(\\d+)(?:\\.(\\d+))?)?)?(?:(?!CFNetwork).)*$");
parser[1] = 0;
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("(Java)/\\d+\\.(\\d+)\\.(\\d+)_(\\d+)");
parser[1] = "Java";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("(?:(?:iPhone|Windows CE|Android).*(?:(?:Bot|Yeti)-Mobile|YRSpider|bots?/\\d|(?:bot|spider)\\.html)|AdsBot-Google-Mobile.*iPhone)");
parser[1] = "Spider";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("; *(T-(?:(?!01)\\d{2})[^;/]+) Build");
parser[1] = "$1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("; *(T\\-01[^;/]+) Build");
parser[1] = "$1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("; *(Orange Daytona|Pulse|Pulse Mini|Vodafone 858|C8500|C8600|C8650|C8660) Build");
parser[1] = "Huawei $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("; *(?:HTC)(?:[ _/]((?:(?![ _/;\\(\\)]|Build|MIUI).)+))(?:[ _/]((?:(?![ _/;\\(\\)]|HTC|Build|MIUI).)+))?(?:[ _/]((?:(?![ _/;\\(\\)]|Build|MIUI).)+))?(?:[ _/]((?:(?![/;\\)]|Build|MIUI).)+))?(?:[/\\\\]1\\.0 | V|/| +)\\d+\\.\\d[\\d\\.]+");
...
parser = Object.create(null);
parser[0] = new RegExp("; *(?:HTC[ ;])?(?:HTC(?:_blocked)*)(?:(?:[ _/]|; *)((?:(?![ _/;\\(\\)\\\\]|USCCHTC|HTC|Build|MIUI).)+))(?:[ _/]((?:(?![ _/;\\(\\)\\\\]|Build|MIUI|1\\.0).)+))?(?:[ _/]((?:(?![ _/;\\(\\)\\\\]|Build|MIUI|1\\.0).)+))?(?:[ _/]((?:(?![/;\\)]|Build|MIUI|1\\.0).)+))?");
parser[1] = "HTC $1 $2 $3 $4";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("; *(ADR6200|ADR6400L|ADR6425LVW|Amaze|DesireS?|EndeavorU|Eris|EVO|Evo\\d[A-Z]+|HD2|IncredibleS?|Inspire[A-Z0-9]*|Inspire[A-Z0-9]*|Sensation[A-Z0-9]*|Wildfire)(?:(?:[ _/\\-])((?:(?![ _/;\\(\\)]|Build|MIUI).)+))(?:[ _/]((?:(?![ _/;\\(\\)]|Build|MIUI|1\\.0).)+))?(?:[ _/]((?:(?![ _/;\\(\\)]|Build|MIUI|1\\.0).)+))?(?:[ _/]((?:(?![/;\\)]|Build|MIUI|1\\.0).)+))?");
parser[1] = "HTC $1 $2 $3 $4";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("; *(?:LNV-)?(?:=?[Ll]enovo[ _\\-]?|LENOVO[ _])+((?:(?!Build|[;/\\)]).)+)[;/]? *(?:Build|[;/\\)])");
parser[1] = "Lenovo $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("; *(E[34][0-9]{2}|LS[6-8][0-9]{2}|VS[6-9][0-9]+[^;/]+|Nexus [45]|GT540f?|Optimus (?:2X|G|4X HD)|OptimusX4HD) *(?:Build|;)");
parser[1] = "$1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("; *(?:meizu_|MEIZU )((?:(?!Build|[;\\)/]).)+) *(?:Build|[;\\)])");
parser[1] = "Meizu $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("; *(Cynus)[ _](F5|T\\d|(?:(?!Build|[;/\\)]).)+) *(?:Build|[;/\\)])");
parser[1] = "$1 $2";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("; *(POMP)[ _\\-]((?:(?!Build|[;/\\)]).)+) *(?:Build|[;/\\)])");
parser[1] = "$1 $2";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("(?:; *|^)((?:GT\\-[BIiNPS]\\d{4}|I9\\d{2}0[A-Za-z\\+]?\\b)(?:(?! +Build| Linux| MIUI|[;/\\)]).)*);?(?: +Build| Linux| MIUI|[;/\\)])");
parser[1] = "Samsung $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("; *(Sprint )((?:(?!Build|[;/]).)+) *(?:Build|[;/])");
parser[1] = "$1$2";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("\\b(T-Mobile)[_ ]?((?:(?!Build).)*)Build");
parser[1] = "$1 $2";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("(TOUCH(?:TAB|PAD)(?:(?! Build).)+) Build/");
parser[1] = "Versus $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("; *(MI \\d[^;/]*|MI-ONE Plus) Build/");
parser[1] = "XiaoMi $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Windows Phone [^;]+; (?:(?!IEMobile/).)*IEMobile/[^;\\)]+[;\\)] ?(?:ARM; ?Touch; ?|Touch; ?)?(?:ALCATEL)[^;]*; *([^;,\\)]+)");
parser[1] = "Alcatel $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Windows Phone [^;]+; (?:(?!IEMobile/).)*IEMobile/[^;\\)]+[;\\)] ?(?:ARM; ?Touch; ?|Touch; ?|WpsLondonTest; ?)?(?:ASUS|Asus)[^;]*; *([^;,\\)]+)");
parser[1] = "Asus $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Windows Phone [^;]+; (?:(?!IEMobile/).)*IEMobile/[^;\\)]+[;\\)] ?(?:ARM; ?Touch; ?|Touch; ?)?(?:DELL|Dell)[^;]*; *([^;,\\)]+)");
parser[1] = "Dell $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Windows Phone [^;]+; (?:(?!IEMobile/).)*IEMobile/[^;\\)]+[;\\)] ?(?:ARM; ?Touch; ?|Touch; ?|WpsLondonTest; ?)?(?:HTC|Htc|HTC_blocked[^;]*)[^;]*; *(?:HTC)?([^;,\\)]+)");
parser[1] = "HTC $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Windows Phone [^;]+; (?:(?!IEMobile/).)*IEMobile/[^;\\)]+[;\\)] ?(?:ARM; ?Touch; ?|Touch; ?)?(?:HUAWEI)[^;]*; *(?:HUAWEI )?([^;,\\)]+)");
parser[1] = "Huawei $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Windows Phone [^;]+; (?:(?!IEMobile/).)*IEMobile/[^;\\)]+[;\\)] ?(?:ARM; ?Touch; ?|Touch; ?)?(?:LG|Lg)[^;]*; *(?:LG[ \\-])?([^;,\\)]+)");
parser[1] = "LG $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Windows Phone [^;]+; (?:(?!IEMobile/).)*IEMobile/[^;\\)]+[;\\)] ?(?:ARM; ?Touch; ?|Touch; ?)?(?:NOKIA|Nokia)[^;]*; *(?:NOKIA ?|Nokia ?|LUMIA ?|[Ll]umia ?)*(\\d{3,}[^;\\)]*)");
parser[1] = "Lumia $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Windows Phone [^;]+; (?:(?!IEMobile/).)*IEMobile/[^;\\)]+[;\\)] ?(?:ARM; ?Touch; ?|Touch; ?)?(?:NOKIA|Nokia)[^;]*; *(RM-\\d{3,})");
parser[1] = "Nokia $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("(?:Windows Phone [^;]+; (?:(?!IEMobile/).)*IEMobile/[^;\\)]+[;\\)]|WPDesktop;) ?(?:ARM; ?Touch; ?|Touch; ?)?(?:NOKIA|Nokia)[^;]*; *(?:NOKIA ?|Nokia ?|LUMIA ?|[Ll]umia ?)*([^;\\)]+)");
parser[1] = "Nokia $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Windows Phone [^;]+; (?:(?!IEMobile/).)*IEMobile/[^;\\)]+[;\\)] ?(?:ARM; ?Touch; ?|Touch; ?)?(?:Microsoft(?: Corporation)?)[^;]*; *([^;,\\)]+)");
...
parser = Object.create(null);
parser[0] = new RegExp("Windows Phone [^;]+; (?:(?!IEMobile/).)*IEMobile/[^;\\)]+[;\\)] ?(?:ARM; ?Touch; ?|Touch; ?|WpsLondonTest; ?)?(?:SAMSUNG)[^;]*; *(?:SAMSUNG )?([^;,\\.\\)]+)");
parser[1] = "Samsung $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Windows Phone [^;]+; (?:(?!IEMobile/).)*IEMobile/[^;\\)]+[;\\)] ?(?:ARM; ?Touch; ?|Touch; ?|WpsLondonTest; ?)?(?:TOSHIBA|FujitsuToshibaMobileCommun)[^;]*; *([^;,\\)]+)");
parser[1] = "Toshiba $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Windows Phone [^;]+; (?:(?!IEMobile/).)*IEMobile/[^;\\)]+[;\\)] ?(?:ARM; ?Touch; ?|Touch; ?|WpsLondonTest; ?)?([^;]+); *([^;,\\)]+)");
parser[1] = "$1 $2";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("(?:NOKIA|Nokia)(?:\\-| *)(?:([A-Za-z0-9]+)\\-[0-9a-f]{32}|((?:(?!UCBrowser)[A-Za-z0-9\\-])+))");
parser[1] = "Nokia $1$2";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("\\bHTC[ _\\-]?((?:(?!-?Mozilla|fingerPrint|[;/\\(\\)]).)+)");
parser[1] = "HTC $1";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Android[\\- ][\\d]+\\.[\\d]+\\-update1; [A-Za-z]{2}\\-[A-Za-z]{0,2} *; *((?:(?!Build).)+) Build");
parser[1] = 0;
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Android[\\- ][\\d]+(?:\\.[\\d]+){1,2}; *[A-Za-z]{2}[_\\-][A-Za-z]{0,2}\\-? *; *((?:(?!Build).)+) Build");
parser[1] = 0;
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Android[\\- ][\\d]+(?:\\.[\\d]+){1,2}; *[A-Za-z]{0,2}\\- *; *((?:(?!Build).)+) Build");
parser[1] = 0;
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Android[\\- ][\\d]+(?:\\.[\\d]+){1,2}; *\\-?[A-Za-z]{2}; *((?:(?!Build).)+) Build");
parser[1] = 0;
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("Android[\\- ][\\d]+(?:\\.[\\d]+){1,2}(?:;.*)?; *((?:(?! Build).)+) Build");
parser[1] = 0;
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
