...
parser = Object.create(null);
parser[0] = new RegExp("Opera Mobi.+(Opera)/(\\d+)\\.(\\d+)");
parser[1] = "Opera Mobile";
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
...
parser = Object.create(null);
parser[0] = new RegExp("CFNetwork/.* Darwin/(14)\\.\\d+");
parser[1] = "iOS";
parser[2] = "7";
parser[3] = 0;
parser[4] = 0;
